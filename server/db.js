...
function seedContent(page, section, key, en, fr) {
  ...
  if (!exists) {
    db.prepare('INSERT INTO site_content (page, section, content_key, value_en, value_fr, value_es) VALUES (?, ?, ?, ?, ?, ?)').run(page, section, key, en, fr, '');
  }
}
...
if (contentCount.c === 0) {
  ...
  seedContent('personas', 'page', 'joinCta', 'Join our Community', 'Rejoindre notre communauté');
...
if (plansCount.c === 0) {
  ...
  insertPlan.run('Stage', 'Free', 'Beginners, curious movers, and anyone who wants to start dancing for fun', 'Débutants et curieux du mouvement', 'iPhone · Android', 'Introductory · Accessible · Essential', 'Introductif · Accessible · Essentiel', 0, 1);
